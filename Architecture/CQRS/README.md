...
- **U nás** — čtecí modely plněné z DX zpráv jsou v podstatě stupeň 4: read-model služba dostane dokumentový event a poskládá si vlastní pohled. Eventuální konzistence tam **je** a počítá se s ní.
