...
| Pattern | Vztah |
| ------- | ----- |
| [Iterator](../../GoF/Behavioral/Iterator/) (GoF) | First Class Collection ho v PHP typicky implementuje přes `IteratorAggregate`. Iterator řeší *jak procházet*, tahle kolekce *co skupina znamená*. |
