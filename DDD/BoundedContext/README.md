...
- **U nás** — každá služba na platformě je bounded context; DX zprávy a SDK jsou právě ten překlad na hranici. Že „objednávka“ znamená v každé službě trochu něco jiného, je vlastnost, ne nedostatek.
