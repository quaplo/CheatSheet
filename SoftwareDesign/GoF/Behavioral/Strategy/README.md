...
| [Replace Conditional with Polymorphism](../../../../Refactoring/Code/ReplaceConditionalWithPolymorphism/) (refaktoring) | **Jak se sem dostat z existujícího kódu** — krok za krokem, když se tentýž `switch` opakuje na víc místech. |
