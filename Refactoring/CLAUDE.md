...
- **[`PreparatoryRefactoring/`](PreparatoryRefactoring/)**, **[`CharacterizationTests/`](CharacterizationTests/)** a **[`ComprehensionRefactoring/`](ComprehensionRefactoring/)** — *kdy* refaktorovat, *s čím* a *jak* pochopit kód, který měníš; leží na úrovni sekce, protože se netýkají jedné úrovně, ale všech technik.
